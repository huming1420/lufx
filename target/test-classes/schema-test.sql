-- Test Schema for H2 in-memory database (PostgreSQL compatible)
-- Note: H2 does NOT support UPSERT with ON CONFLICT the same way as PostgreSQL.
-- We use MERGE or INSERT ... ON DUPLICATE KEY for H2.

-- insight_result table
